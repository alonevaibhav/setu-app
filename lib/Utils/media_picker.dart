...
// Usage Examples:
// Specific picker methods for different use cases:

// // Documents only picker (Most important for business communication)
...
//       maxFileSize: 100, // Higher limit for documents
//       onDocumentsSelected: (documentPaths) {
//         uploadedDocumentPaths.addAll(documentPaths);
//         Get.snackbar(
//           'Success',
//           '${documentPaths.length} ${documentPaths.length == 1 ? 'document' : 'documents'} added',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
// }
//
// // PDF only picker (Very common in business)
// void selectPDFOnly() {
//   Get.bottomSheet(
//     MediaPickerWidget(
...
//         Get.snackbar(
//           'Success',
//           '${documentPaths.length} PDF ${documentPaths.length == 1 ? 'file' : 'files'} added',
//           snackPosition: SnackPosition.BOTTOM,
...
// }
//
// // Updated sendMessage method to handle all file types:
// Future<void> sendMessage() async {
//   final message = messageController.text.trim();
//   if (message.isEmpty &&
//       uploadedImagePaths.isEmpty &&
//       uploadedVideoPaths.isEmpty &&
//       uploadedDocumentPaths.isEmpty &&
//       uploadedAudioPaths.isEmpty) return;
//
//   try {
...
//
//     // Add document files
//     for (var path in uploadedDocumentPaths) {
//       files.add(MultipartFiles(
//         field: 'attachments',
//         filePath: path,
//       ));
...
//
//     // Add audio files
//     for (var path in uploadedAudioPaths) {
//       files.add(MultipartFiles(
//         field: 'attachments',
//         filePath: path,
//       ));
...
//       uploadedDocumentPaths.clear();
//       uploadedAudioPaths.clear();
//
...
// }
//
// // Helper method to get file type// Updated methods for your TicketChatController
//
// // Add these new observable lists to your controller class:
// final uploadedDocumentPaths = <String>[].obs;
// final uploadedAudioPaths = <String>[].obs;
//
// // Replace your existing uploadMedia method with this complete version:
// void uploadMedia() {
//   Get.bottomSheet(
//     MediaPickerWidget(
//       title: 'Select Files',
...
//       allowMultipleDocuments: true,
//       allowMultipleAudio: false,
//       maxVideoDuration: const Duration(minutes: 5),
//       maxFileSize: 50, // 50MB file size limit
//       onImagesSelected: (imagePaths) {
//         uploadedImagePaths.addAll(imagePaths);
//         Get.snackbar(
//           'Success',
//           '${imagePaths.length} ${imagePaths.length == 1 ? 'photo' : 'photos'} added successfully',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
//         );
//       },
//       onVideosSelected: (videoPaths) {
//         uploadedVideoPaths.addAll(videoPaths);
//         Get.snackbar(
//           'Success',
//           '${videoPaths.length} ${videoPaths.length == 1 ? 'video' : 'videos'} added successfully',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
//         Get.snackbar(
//           'Success',
//           '${documentPaths.length} ${documentPaths.length == 1 ? 'document' : 'documents'} added successfully',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
//         );
//       },
//       onAudioSelected: (audioPaths) {
//         uploadedAudioPaths.addAll(audioPaths);
//         Get.snackbar(
//           'Success',
//           '${audioPaths.length} audio ${audioPaths.length == 1 ? 'file' : 'files'} added successfully',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
// }
//
// // You can also create specific methods for different use cases:
//
// // Method for image-only selection
// void selectImages() {
//   Get.bottomSheet(
//     MediaPickerWidget(
//       title: 'Select Images',
...
//         Get.snackbar(
//           'Success',
//           '${imagePaths.length} ${imagePaths.length == 1 ? 'photo' : 'photos'} added',
//           snackPosition: SnackPosition.BOTTOM,
//           backgroundColor: Colors.green,
//           colorText: Colors.white,
//           duration: const Duration(seconds: 2),
...
// }
//
// // Method for video-only selection
// void selectVideos() {
//   Get.bottomSheet(
//     MediaPickerWidget(
//       title: 'Select Video',
...
// }
//
// // Method for single image selection only
...
//           uploadedImagePaths.add(imagePaths.first);
//           Get.snackbar(
//             'Success',
...
// }
//
// // You can now remove all the old methods:
// // - _showMediaSourceDialog()
// // - _pickImage()
// // - _pickMultipleImages()
// // - _pickVideo()
// // These are now handled by the MediaPickerWidget