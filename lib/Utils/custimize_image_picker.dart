...
//                         ? hint
//                         : '${uploadedFiles.length} file${uploadedFiles.length >
//                         1 ? 's' : ''} selected',
//                     style: GoogleFonts.poppins(
//                       fontSize: 16.sp * sizeFactor,
//                       color: uploadedFiles.isEmpty
...
//   }
//
//   /// Show File Upload Dialog - Clean version
...
//       context: Get.context!,
//       title: 'Select Files',
//       onImagesSelected: acceptImages ? (imagePaths) {
//         onFilesSelected(imagePaths);
//       } : null,
//       onDocumentsSelected: acceptDocuments ? (documentPaths) {
...
//     bool allowMultipleDocuments = true,
...
//                   // Photos Section
//                   _buildSectionHeader(
//                       'Photos', PhosphorIcons.camera(PhosphorIconsStyle.fill)),
//                   Gap(12.h * sizeFactor),
//
...
//                     onTap: () => _pickImage(
//                         context, ImageSource.camera, onImagesSelected),
//                   ),
//
//                   Gap(8.h * sizeFactor),
//
...
//                     onTap: () => _pickImage(
//                         context, ImageSource.gallery, onImagesSelected),
//                   ),
//
//                   if (allowMultipleImages) ...[
//                     Gap(8.h * sizeFactor),
//                     _buildMediaOptionTile(
//                       icon: PhosphorIcons.images(PhosphorIconsStyle.fill),
//                       title: 'Multiple Photos',
//                       subtitle: 'Choose multiple photos',
//                       onTap: () =>
//                           _pickMultipleImages(context, onImagesSelected),
//                     ),
//                   ],
//
//                   Gap(24.h * sizeFactor),
...
//                         context, ['pdf'], onDocumentsSelected, maxFileSize),
//                   ),
//
//                   Gap(8.h * sizeFactor),
//
...
//                     onTap: () => _pickDocuments(
//                         context, ['doc', 'docx'], onDocumentsSelected,
//                         maxFileSize),
//                   ),
//
...
//                       onTap: () => _pickDocuments(
//                           context, ['pdf', 'doc', 'docx'], onDocumentsSelected,
//                           maxFileSize),
//                     ),
//                   ],
//
...
//           ),
//           child: Icon(
//               icon, color: SetuColors.primaryGreen, size: 20.w * sizeFactor),
//         ),
//         Gap(12.w * sizeFactor),
//         buildTranslatableText(
//           text: title,
...
//                 decoration: BoxDecoration(
//                   color: (iconColor ?? SetuColors.primaryGreen).withOpacity(
//                       0.1),
//                   borderRadius: BorderRadius.circular(12.r * sizeFactor),
//                 ),
//                 child: Icon(
...
//
//   /// Pick Single Image
//   static Future<void> _pickImage(BuildContext context,
//       ImageSource source,
//       Function(List<String> imagePaths)? onImagesSelected,) async {
//     try {
...
//   static Future<void> _pickMultipleImages(BuildContext context,
//       Function(List<String> imagePaths)? onImagesSelected,) async {
//     try {
//       final ImagePicker picker = ImagePicker();
...
//         _showSuccessMessage('${images.length} photos added successfully');
//       }
//     } catch (e) {
...
//
//   /// Pick Documents
//   static Future<void> _pickDocuments(BuildContext context,
//       List<String> allowedExtensions,
//       Function(List<String> documentPaths)? onDocumentsSelected,
...
//
//       if (result != null) {
//         List<String> filePaths = result.paths.where((path) => path != null)
//             .cast<String>()
//             .toList();
//
//         // Check file sizes
...
//           _showSuccessMessage('${filePaths.length} ${filePaths.length == 1
//               ? 'document'
...
//       borderRadius: 12.r * sizeFactor,
//       icon: Icon(
//           PhosphorIcons.warning(PhosphorIconsStyle.fill), color: Colors.white),
//     );
//   }
// }
