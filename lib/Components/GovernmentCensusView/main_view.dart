...
class GovernmentCensusView extends StatelessWidget {
  const GovernmentCensusView({Key? key}) : super(key: key);
  ...
  Widget _buildStepIndicator(
      GovernmentCensusController controller,
      int step,
      String title,
      IconData icon,
      double sizeFactor,
  ...
  Widget _buildSubStepProgress(GovernmentCensusController controller, double sizeFactor) {
    return Container(
  ...
  Widget _buildInputContainer(GovernmentCensusController controller, double sizeFactor) {
    return Container(
