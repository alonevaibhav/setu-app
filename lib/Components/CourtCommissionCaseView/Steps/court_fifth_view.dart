...
//   }
//
//   Widget _buildPlaintiffDefendantEntries(CourtFifthController courtFifthController) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
...
//                 InkWell(
//                   onTap: () => courtFifthController.removePlaintiffDefendantEntry(index),
//                   child: Container(
//                     padding:
//                     EdgeInsets.all(8.w * CourtCommissionCaseUIUtils.sizeFactor),
//                     decoration: BoxDecoration(
...
//             label: 'Select Type *',
//             value: entry['selectedType'].value.isEmpty ? '' : entry['selectedType'].value,
...
//             onChanged: (value) =>
//                 courtFifthController.updatePlaintiffDefendantEntry(index, 'name', value),
//           ),
//
//           Gap(16.h * CourtCommissionCaseUIUtils.sizeFactor),
//
...
//             maxLines: 3,
//             onChanged: (value) =>
//                 courtFifthController.updatePlaintiffDefendantEntry(index, 'address', value),
//           ),
//
//           Gap(16.h * CourtCommissionCaseUIUtils.sizeFactor),
//
...
//             onChanged: (value) =>
//                 courtFifthController.updatePlaintiffDefendantEntry(index, 'mobile', value),
//           ),
//
//           Gap(16.h * CourtCommissionCaseUIUtils.sizeFactor),
//
...
//             onChanged: (value) => courtFifthController.updatePlaintiffDefendantEntry(
