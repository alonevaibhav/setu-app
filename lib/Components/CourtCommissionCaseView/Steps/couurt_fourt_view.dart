...
import '../Controller/court_fourth_controller.dart';
import '../Controller/main_controller.dart';
import 'ZLandAcquisitionUIUtils.dart';

class CouurtFourtView extends StatelessWidget {
  final int currentSubStep;
  final CourtCommissionCaseController mainController;

  const CouurtFourtView({
    Key? key,
  ...
  CourtFourthController get controller =>Get.put(CourtFourthController(), tag: 'step_four');
