...
//// Custom Date Picker with attractive design - WORKING VERSION
  ...
  static Widget buildQuestionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12.r * CourtAllocationCaseUIUtils.sizeFactor),
  ...
  static Widget buildOptionButton({
    ...
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(8.r * CourtAllocationCaseUIUtils.sizeFactor),
      child: Container(
        padding: EdgeInsets.symmetric(
          vertical: 12.h * CourtAllocationCaseUIUtils.sizeFactor,
        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              size: 18.w * CourtAllocationCaseUIUtils.sizeFactor,
            ),
  ...
  static Widget buildNavigationButtons(CourtAllocationCaseController controller) {
    return Obx(() => Row(
          children: [
            // Previous Button
