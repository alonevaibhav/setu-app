...
class CourtAllocationCaseView extends StatelessWidget {
  const CourtAllocationCaseView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CourtAllocationCaseController());
  ...
  Widget _buildStepIndicator(
      CourtAllocationCaseController controller,
      int step,
      String title,
      IconData icon,
      double sizeFactor,
  ...
  Widget _buildSubStepProgress(CourtAllocationCaseController controller, double sizeFactor) {
    return Container(
  ...
  Widget _buildInputContainer(CourtAllocationCaseController controller, double sizeFactor) {
    return Container(
