...
// import '../Controller/survey_seventh_controller.dart';
//
// class SurveySeventhView extends StatelessWidget {
//   final int currentSubStep;
//   final MainSurveyController mainController;
//
//   const SurveySeventhView({
//     Key? key,
...
//   }
//
//   Widget _buildNextOfKinEntries(SurveySeventhController surveyEightController) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
...
//       SurveySeventhController surveyEightController, int index) {
...
class SurveySeventhView extends StatelessWidget {
  ...
  Widget _buildSubEntriesSection(SurveySeventhController surveyEightController, int index) {
    final entry = surveyEightController.nextOfKinEntries[index];
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Gap(4.w * SurveyUIUtils.sizeFactor),
                    Text(
                      'Add',
                      style: TextStyle(
                        fontSize: 14.sp * SurveyUIUtils.sizeFactor,
  ...
  Widget _buildSubEntryCard(
      SurveySeventhController surveyEightController, int parentIndex, int subIndex) {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Container(
                padding: EdgeInsets.symmetric(
                  horizontal: 10.w * SurveyUIUtils.sizeFactor,
              ...
              if (subEntries.length > 1)
                InkWell(
                  onTap: () =>
                      surveyEightController.removeSubEntry(parentIndex, subIndex),
                  child: Container(
                    padding: EdgeInsets.all(6.w * SurveyUIUtils.sizeFactor),
                    decoration: BoxDecoration(
                      color: Colors.red.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(6.r),
                    ),
          ...
          Gap(12.h * SurveyUIUtils.sizeFactor),
