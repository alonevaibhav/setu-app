    ...
    return Column(
      ...
      children: [
        ...
        SurveyUIUtils.buildDatePickerField(
          ...
          label:
              'Date of order passed by the competent authority or date of letter issued for counting *',
          hint: 'dd-mm-yyyy',
        ...
        SurveyUIUtils.buildTextFormField(
          ...
          label:
              'Order number of the scheme approved by the competent authority *',
        ...
        SurveyUIUtils.buildDatePickerField(
          ...
          label:
              'Date of the order of appointment approved by the competent authority *',
          hint: 'dd-mm-yyyy',
          icon: PhosphorIcons.calendar(PhosphorIconsStyle.regular),
          validator: (value) {
            if (value == null || value.trim().isEmpty) {
        ...
        _buildEntryList(
          title:
              'Survey number / Group No. to be used for non-agricultural census. Fill in as per your 7/12.',
          entries: calcController.nonAgriculturalEntries,
          onAddMore: calcController.addNonAgriculturalEntry,
          itemBuilder: (index) =>
              _buildNonAgriculturalCard(calcController, index),
        ),
      ],
    );
  }

  Widget _buildNonAgriculturalCard(
    ...
    return _buildEntryCard(
      ...
      index: index,
      onMarkCorrect: () =>
          calcController.markNonAgriculturalEntryCorrect(index),
  ...
  Widget _buildKnotsCountingFields(CalculationController calcController) {
    return Column(
      ...
      children: [
        ...
        _buildEntryList(
          title:
              'Fill in the survey number/group number to be counted by gunthewari as per your 7/12.',
          entries: calcController.knotsCountingEntries,
          onAddMore: calcController.addKnotsCountingEntry,
          itemBuilder: (index) =>
              _buildKnotsCountingCard(calcController, index),
        ),
      ],
    );
  }

  Widget _buildKnotsCountingCard(
      CalculationController calcController, int index) {
    ...
    return Column(
      ...
      children: [
        ...
        SurveyUIUtils.buildTextFormField(
          ...
          label:
              'Number of the merger order approved by the competent authority *',
        ...
        ImagePickerUtil.buildFileUploadField(
          label:
              'Map of the order of incorporation approved by the competent authority *',
        ...
        _buildEntryList(
          ...
          itemBuilder: (index) =>
              _buildIntegrationCalculationCard(calcController, index),
        ),
      ],
    );
  }

  Widget _buildIntegrationCalculationCard(
      CalculationController calcController, int index) {
    ...
    return _buildEntryCard(
      ...
      index: index,
      onMarkCorrect: () =>
          calcController.markIntegrationCalculationEntryCorrect(index),
        ...
        children: [
          ...
          SurveyUIUtils.buildTextFormField(
            ...
            onChanged: (value) => calcController
                .updateIntegrationCalculationEntry(index, 'area', value),
          ),
          Gap(16.h * SurveyUIUtils.sizeFactor),
