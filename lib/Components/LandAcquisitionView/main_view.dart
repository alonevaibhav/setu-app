...
class LandAcquisitionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MainLandAcquisitionController());
  ...
  Widget _buildStepIndicator(
      MainLandAcquisitionController controller,
      int step,
      String title,
      IconData icon,
      double sizeFactor,
  ...
  Widget _buildSubStepProgress(MainLandAcquisitionController controller, double sizeFactor) {
    return Container(
  ...
  Widget _buildInputContainer(MainLandAcquisitionController controller, double sizeFactor) {
    return Container(
