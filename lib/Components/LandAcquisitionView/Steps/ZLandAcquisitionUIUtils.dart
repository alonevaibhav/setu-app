...
class LandAcquisitionUIUtils {
  ...
  static Widget buildOptionButton({
    ...
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(8.r * LandAcquisitionUIUtils.sizeFactor),
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              size: 18.w * LandAcquisitionUIUtils.sizeFactor,
            ),
  ...
  static Widget buildNavigationButtons(MainLandAcquisitionController controller) {
    return Obx(() => Row(
          children: [
            // Previous Button
