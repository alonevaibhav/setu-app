...
//
//
//     final docController = Get.put(LandSeventhController(), tag: 'survey_seven');
//
...
class LandSeventhView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final docController = Get.put(LandSeventhController(), tag: 'survey_seventh');
  ...
  Widget _buildDocumentUpload(LandSeventhController docController) {
    return SingleChildScrollView(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
